...
# VC_TOKEN_FILE / VC_CURL_CFG / VC_HDR_FILE — mktemp paths for the vCenter session's credential
...
# less safe. VC_LAST_CODE is the last HTTP status, an output. SVC_STATUS is a caller-local.
