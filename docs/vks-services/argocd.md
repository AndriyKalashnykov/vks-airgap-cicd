...
|---|---|---|
| Packaging | **Supervisor Service** (operator + an ArgoCD instance CR), on the **Supervisor** | 9.0-doc (9.1-RN confirms the Service exists) [src: url=https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-service-administration-and-development/9-0/using-supervisor-services/using-argo-cd-service/install-argo-cd-service.html date=2026-07-15 quote="You deploy the VMware Argo CD Operator on the Supervisor and then install an Argo CD instance in a vSphere Namespace"] |
| Namespace | a vSphere Namespace, e.g. `argocd-instance-1` | 9.0-doc [src: url=https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-service-administration-and-development/9-0/using-supervisor-services/using-argo-cd-service/install-argo-cd-service.html date=2026-07-15 quote="namespace: argocd-instance-1"] |
